...
if(a22)
{
window[a7+'_SkipEmptyValidation']=true;
}
if(a0)
{
a20[_LovPT]=a0;
...
{
var a4=_simpleDateParseImpl(a0,
a2[a3],
this._localeSymbols,
a1);
if(a4!=(void 0))
...
a4.currIndex=0;
a4.parseString=a0;
a4.parsedHour=(void 0);
a4.parsedMinutes=(void 0);
a4.parsedSeconds=(void 0);
a4.parsedMilliseconds=(void 0);
a4.isPM=false;
a4.parsedBC=false;
a4.parsedFullYear=(void 0);
a4.parsedMonth=(void 0);
a4.parsedDate=(void 0);
a4.parseException=new ParseException();
var a5;
if((typeof(_cal)!="undefined")&&(_cal==_THAI_BUDDHA))
{
a5=new BuddhistDate(0);
}
else if((typeof(_cal)!="undefined")
&&((_cal==_ENGLISH_HIJRAH)||(_cal==_ARABIC_HIJRAH)))
{
...
a5))
{
if(a0.length!=a4.currIndex)
{
return(void 0);
}
var a6=a4.parsedFullYear;
if(a6!=(void 0))
{
if(a4.parsedBC)
{
a6=_getADEra().getFullYear()-a6;
}
a5.setFullYear(a6);
a4.parsedFullYear=a6;
}
var a7=a4.parsedMonth;
if(a7!=(void 0))
a5.setMonth(a7);
var a8=a4.parsedDate;
if(a8!=(void 0))
a5.setDate(a8);
var a9=_getStartTimeOfDay(a8,a7,a6);
var a10=a4.parsedHour;
if(a10!=(void 0))
{
if(a4.isPM&&(a10<12))
{
...
{
a5.setHours(a9.hours);
}
var a11=a4.parsedMinutes;
if(a11!=(void 0))
{
a5.setMinutes(a11);
}
...
{
a5.setMinutes(a9.minutes);
}
var a12=a4.parsedSeconds;
if(a12!=(void 0))
a5.setSeconds(a12);
else
a5.setSeconds(0);
var a13=a4.parsedMilliseconds;
if(a13!=(void 0))
a5.setMilliseconds(a13);
else
a5.setMilliseconds(0);
if(!_isStrict(a4,a5))
{
if(_isSkippedTime(a4,a5)&&a3)
{
a3.ERROR_CODE="SKIPPED_TIME";
}
return(void 0);
}
return a5;
...
function _isSkippedTime(
a0,
a1)
{
var a2=a0.parsedHour;
if(a0.parsedFullYear!=(void 0)&&
a0.parsedMonth!=(void 0)&&
a0.parsedDate!=(void 0)&&a2!=(void 0))
{
if(a0.isPM&&(a2<12))
{
a2+=12;
}
var a3=a0.parsedMinutes;
var a4=a0.parsedSeconds;
if(a2>=23||(a3!=(void 0)&&a3>=59)||
(a4!=(void 0)&&a4>=59))
{
return false;
}
if(a3!=(void 0)&&a3!=a1.getMinutes())
{
return true;
}
if(a2!=(void 0)&&a2!=a1.getHours())
{
return true
}
}
...
a1)
{
if(_isHijrahCal()&&!_isValidHijrahDate(a1))
{
return false;
}
...
{
if(a18&&a18.parentNode)
a18.parentNode.removeChild(a18);
}
}
}
return a8;
...
var a4=true;
var a5=a0.name;
var a6=window[a5+'_SkipEmptyValidation'];
window[a5+'_SkipEmptyValidation']=false;
for(var a7=0;a7<a1.length;a7+=4)
{
var a8=a0[a1[a7+1]];
var a9=a8.type;
if(!a9&&a8.length)
...
var a11=_getValue(a8);
if(!(a10&&(a11=="")))
{
var a12=_getValidationError(a8,a1[a7],
a3);
if(a12)
{
...
var a8=window["_"+a4.name+"_Labels"];
var a9;
if(a8)
{
a9=a8[_getID(a0)];
}
var a10=window["_"+a4.name+"_Patterns"];
var a11;
if(a10)
{
a11=a10[_getID(a0)];
}
var a12=_formatErrorString(a3,
{
"value":a5,
"label":a9,
"pattern":a11
...
{
var a1={ERROR_CODE:''};
var a2=this.parse(a0,a1);
if(a2==(void 0))
{
if("SKIPPED_TIME"==a1.ERROR_CODE)
{
return"Failed SKIPPED_TIME:"+this._class+" for value:"+a0;
}
return"Failed:"+this._class+" for value:"+a0;
}
else if(_instanceof(a2,ParseException))
{
return a2;
}
else
